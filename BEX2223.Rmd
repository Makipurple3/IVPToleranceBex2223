...
# Check amount of occurences of Tolerance, Aggresssion and NotApproaching in dataset!



# Make Tolerance,Tol, Aggression, Agg and Not Approaching, NotApp binomial

ables (Tol, Agg, NotApp)
BexClean<- BexClean %>%
  mutate(
