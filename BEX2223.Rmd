...
* In order to facilitate the identification of key words in the remarks, I used an AI to analyze the **614 unique outputs of Remarks**:
...
```{r Remarks - Numercial value, echo=FALSE}
