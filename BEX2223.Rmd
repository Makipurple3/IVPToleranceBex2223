...
```{r Cleaning remaining NA, echo=FALSE}
...
* It seems now that no NA's are remaining in the dataset, we can thus continue with the rest

### Creating New Variables and cleaning the remaining ones
