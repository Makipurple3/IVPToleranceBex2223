...
* After the changes we can effectively see that we have **2181 "No Remarks"** confirming that the change effectively worked in this column as we have no missing data left
...
* Since **Remarks** contain information that could be distributed in other columns, corrections or additional information, I will explore the variable in more detail
* Now that I have replaced the NA's in Remarks with **No Remarks**, I found out that we have **614 rows with Remarks** that need's to be treated
