...
* I will proceed to clean these variables one by one 
...
# Check if the 'No Remarks' column already exists
...
```
* I will also create a variable called No Remarks to see how many lines with remarks I will have to treat
...
* I also chose to directly create new dichotomic variables for "Not approaching", "Intrusion", "Losing interest", "Distracted", for this I would like the function to
  ...
  3.And **if there are more than one value per cell**, report it in a new column called ">1 Response"
