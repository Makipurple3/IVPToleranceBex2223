...
# Function to update specific rows in the dataframe for rows 286, 300, and 304
update_rows_286_300_304 <- function(df) {
  ...
  df_updated <- df %>%
    mutate(
      DyadResponse = ifelse(criteria_286 | criteria_300, "Tolerance", DyadResponse),
  ...
  total_rows_changed <- rows_changed_286 + rows_changed_300 + rows_changed_304

  # Return the updated dataframe and number of rows changed
  return(list(df_updated, total_rows_changed))
}

# Process the dataframe to update rows 286, 300, and 304
result_286_300_304 <- update_rows_286_300_304(BexClean)

# Extract the updated dataframe and rows changed
BexClean_286_300_304 <- result_286_300_304[[1]]
rows_changed_286_300_304 <- result_286_300_304[[2]]

# Display the number of rows changed
cat("Number of rows changed for 286, 300, and 304: ", rows_changed_286_300_304, "\n")

# View the updated rows to ensure correctness
updated_rows_286_300_304 <- BexClean_286_300_304 %>%
  filter(MaleID == "Kom" & FemaleID == "Oort" & DyadResponse == "Tolerance")
print(updated_rows_286_300_304)
