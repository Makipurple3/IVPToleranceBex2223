...
# Summarize the total amount of corn received by each male and female
...
plot_male_corn <- ggplot(summary_male_corn, aes(x = reorder(MaleID, -Total_Corn), y = Total_Corn, fill = MaleID)) +
  ...
  labs(title = "Total Amount of Corn Received by Males", x = "MaleID", y = "Total Amount of Corn") +
  theme_minimal() +
  theme(legend.position = "none", text = element_text(size = 14), axis.text.x = element_text(angle = 45, hjust = 1)) +
  custom_colors

# Plot for PlacementFemale
plot_female_corn <- ggplot(summary_female_corn, aes(x = reorder(FemaleID, -Total_Corn), y = Total_Corn, fill = FemaleID)) +
  geom_bar(stat = "identity", width = 0.4) +
  geom_text(aes(label = Total_Corn), vjust = -0.5, size = 4) +
  ...
  labs(title = "Total Amount of Corn Received by Females", x = "FemaleID", y = "Total Amount of Corn") +
  theme_minimal() +
  theme(legend.position = "none", text = element_text(size = 14), axis.text.x = element_text(angle = 45, hjust = 1)) +
  custom_colors
