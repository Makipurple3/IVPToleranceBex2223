...
* After the changes we can effectively see that we have **2181 "No Remarks"** confirming that the change effectively worked in this column
...
* Now that I have replaced the NA's in Remarks with **No Remarks**, I found out that we have **614 rows with Remarks**
