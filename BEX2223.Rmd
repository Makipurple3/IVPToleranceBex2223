...
* I will keep the following variables in the next order: Date, Month, Day, Time, Period, Trial, Male, Female, Dyad, DyadDistance, Proximity, DyadResponse, Intrusion, SpecialBehaviour, Audience, AmountAudience, Context, Special Behaviour
...
BexClean <- BexClean %>%
  select(Date, Month, Day, Time, Hour, Period, Trial, Male, Female, Dyad, 
         DyadDistance, Proximity, DyadResponse, Intrusion, SpecialBehaviour, 
...
# Step 4: Display the updated table in separate sections for Male, Female, and Other categories
cat("\nMale Audience Members:\n")
male_count <- audience_count %>% filter(Category == "Male")
print(male_count)

cat("\nFemale Audience Members:\n")
female_count <- audience_count %>% filter(Category == "Female")
print(female_count)
