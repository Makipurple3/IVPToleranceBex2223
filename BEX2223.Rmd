...
* Note that the 4 letter codes correspond to the femalesID, the 3 letter codes to the males ID and the 2 letter codes to the group name

* First I have to check where are the NA's in both FemaleID and Male ID by looking at the rows where data is missing. Since every trial was made with a Dyad and never with an single individual, treating these two columns together makes more sense. If both individuals are missing I may have to delete the row.
