...
# Function to update specific rows in the dataframe for rows 286, 300, 304, and 1484
update_rows_286_300_304_1484 <- function(df) {
  # Define keywords or patterns for row 1484
  ...
  df_updated <- df %>%
    mutate(
      ...
      GotCorn = ifelse(criteria_286, "No;Oort", GotCorn)  # Adjust based on actual requirement for row 286
    )
  ...
  total_rows_changed <- rows_changed_286 + rows_changed_300 + rows_changed_304 + rows_changed_1484
  
  # Return the updated dataframe and number of rows changed
  return(list(df_updated, total_rows_changed))
}

# Process the dataframe to update rows 286, 300, 304, and 1484
result_286_300_304_1484 <- update_rows_286_300_304_1484(BexClean)

# Extract the updated dataframe and rows changed
BexClean_286_300_304_1484 <- result_286_300_304_1484[[1]]
rows_changed_286_300_304_1484 <- result_286_300_304_1484[[2]]

# Display the number of rows changed
cat("Number of rows changed for 286, 300, 304, and 1484: ", rows_changed_286_300_304_1484, "\n")

# View the updated rows to ensure correctness
updated_rows_286_300_304_1484 <- BexClean_286_300_304_1484 %>%
  filter(MaleID == "Kom" & FemaleID == "Oort" & DyadResponse == "Tolerance")
print(updated_rows_286_300_304_1484)
...
```{r chunk for problmeatic rows in DyadResponse Other, echo=FALSE}
