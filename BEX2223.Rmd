...
* The relative age difference normalizes the raw age difference between two individuals in a dyad, dividing it by the average age of the two. 
* This normalization is essential to compare dyads consisting of younger and older individuals.

F* or instance:

* A 4-year difference between a 10-year-old and a 14-year-old means a 40% difference relative to their average age (12 years).
* The same 4-year difference between a 30-year-old and a 34-year-old represents only a 12.5% difference relative to their average age (32 years).
* This allows for a fairer comparison of age differences across dyads with different age ranges.
...
* Create a column into DyadData describing which individual (Male or Female) is older  within the Dyad

```{r Older Individual in Dyad, echo=FALSE}
