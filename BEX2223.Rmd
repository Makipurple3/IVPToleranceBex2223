...
# Display unique combinations and their frequencies
print(knitr::kable(unique_combinations, col.names = c("Combination", "Frequency"), caption = "Unique DyadResponse Combinations and Their Frequencies", row.names = FALSE))
...
```{r DyadResponse frequency plots before modification Single Response, echo=FALSE}

# Updated code to plot the frequency of single dyad responses
...
# Updated code to plot the frequency of multiple dyad response combinations
...
```{r DyadResponse frequency plots before modification Sing and Multiple Response, echo=FALSE}
