...
# Count occurrences of all variations of "Not Approaching; Not Approaching"
count_not_approaching_duplicates <- function(df) {
  count <- sum(grepl("(?i)\\bNot\\s*approaching\\s*;\\s*Not\\s*approaching\\b", df$DyadResponse, perl=TRUE))
...
# Function to remove duplicate "Not Approaching" occurrences, handling all variations
remove_duplicate_not_approaching <- function(df) {
  # Replace all variations of "Not Approaching; Not Approaching" with a single "Not Approaching"
  df <- df %>%
    mutate(DyadResponse = gsub("(?i)\\bNot\\s*approaching\\s*;\\s*Not\\s*approaching\\b", "Not approaching", DyadResponse, perl = TRUE))
...
# Check the remaining duplicates after removal
