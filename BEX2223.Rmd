...
find_and_remove_other_no_response <- function(df) {
  ...
  # Return updated dataframe, row numbers, count of combinations, and number of rows changed
  return(list(df_updated, row_numbers, count_combinations, rows_changed))
}

# Assuming BexClean is your dataframe
result <- find_and_remove_other_no_response(BexClean)

# Extract the updated dataframe, row numbers, count of combinations, and rows changed
...
# You can now use BexClean_updated for further analysis

```

```{r DyadResponse Others Treatment2 - Deletion, echo=FALSE}
...
```{r DyadResponse Others Treatment3 - Check, echo=FALSE}
