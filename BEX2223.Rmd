...
*Before looking at the NA's of Dyaddistance I will remove the "m" that is in front of every number to have a numerical form for this variable
*Then I will look where are the NA's in the data to look at them case by case
