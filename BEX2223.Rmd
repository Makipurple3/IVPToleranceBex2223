...
Since the column remarks contains corrections and additional information, I would like to treat it now
...
##### 3.3.4 Journal of manual changes in Bex excel spreadsheet
...
write.xlsx(Bex, "Bex_for_manual_cleaning.xlsx", rowNames = FALSE)


```

### Time - Creation of Period and Hour
