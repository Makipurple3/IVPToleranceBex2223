...
* Everytime there is a missing value un Male placement corn we can see a value in Male Corn, I will this create a new variable MaleCorn where every time that there NA in male placement corn the value will be taken in MaleCornOld. If there is no NA it will take the value of ´Male placement corn´
...
```{r Fuse MaleCornOld and male placement corn into MaleCorn}
