...
* **Remarks - not open (9x)**
  ...
  Rows: 320, 377, 632, 780, 899, 1360, 1445, 1652, 2209 
   ...
   1.(Audience)The remarks of the Row 321 indicated that some udience arrived:I       want to replace the values in the column **Audience** of the row **320** and       **321** with **Sey;Piep;Sirk;Oup;Ome**
...
* **Remarks - steal(7)**
  Rows: 417, 893, 909, 1070, 1344, 1393, 1947
...
if (!("Bex" %in% ls())) {
  ...
  rows_to_treat <- c(417, 893, 909, 1070, 1344, 1393, 1947)
...
```{r Remarks - steal cleaning, echo=FALSE}
