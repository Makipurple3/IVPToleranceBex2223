...
#Create Final Bex for statistics:
  
  #  "Date", "Month", "DyadDay", "Trial", "Time", "Period", "Male", "Female", "Dyad",
  #"DyadDistance", "Proximity", "DyadResponse", "SpecialBehaviour", "Context", "ToleranceBinomial",
  # MAge", "FAge", "AgeDiff", "IEloDiff", "Tol", "Agg", "NotApp"
